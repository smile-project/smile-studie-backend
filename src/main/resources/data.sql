...
INSERT INTO page(
	...
	(101, 'Welches Geschlecht haben Sie?', 'Demographische Daten'),
	(102, 'Bitte geben Sie ihr derzeitges Alter in ganzen Jahren an','Demographische Daten'),
	(103, 'Welchen Familienstand haben Sie? Heterogeschlechtlich und gleichgeschlechtliche Partnerschaften werden gleichbehandelt.','Demographische Daten'),
	(104, 'Welchen höchsten allgemeinbildenden Schulabschluss haben Sie? Bitte geben Sie, wenn nötig, einen vergleichbaren Abschluss an.','Demographische Daten'),
	(105, 'Welchen allgemeinbildenden Schulabschluss streben Sie an?','Demographische Daten'),
	(106, 'Wie hoch ist Ihr eigenes durchschnittliches monatliches Nettoeinkommen?', 'Demographische Daten'),

	(201, 'In den meisten Bereichen entspricht mein Leben meinen Idealvorstellungen.', 'SWLS'),
    (202, 'Meine Lebensbedingungen sind ausgezeichnet.', 'SWLS'),
	(203, 'Ich bin mit meinem Leben zufrieden.', 'SWLS'),
	(204, 'Bisher habe ich die wesentlichen Dinge erreicht, die ich mir für mein Leben wünsche.', 'SWLS'),
	(205, 'Wenn ich mein Leben noch einmal leben könnte, würde ich kaum etwas ändern.', 'SWLS'),
	
	(301, 'aktiv','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(302, 'bekümmert','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(303, 'interessiert','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(304, 'freudig erregt','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(305, 'verärgert','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(306, 'stark','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(307, 'schuldig','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(308, 'erschrocken','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(309, 'feindselig','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(310, 'angeregt','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(311, 'stolz','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(312, 'gereizt','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(313, 'begeistert','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(314, 'beschämt','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(315, 'wach','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(316, 'nervös','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(317, 'entschlossen','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(318, 'aufmerksam','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(319, 'durcheinander','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	(320, 'ängstlich','PANAS - Geben Sie bitte an, wie Sie sich in den letzten Wochen gefühlt haben.'),
	
	(401, 'Ich bin eher zurückhaltend, reserviert.', 'BFI-10'),
	(402, 'Ich schenke anderen leicht Vertrauen, glaube an das Gute im Menschen.', 'BFI-10'),
	(403, 'Ich bin bequem, neige zur Faulheit.', 'BFI-10'),
	(404, 'Ich bin entspannt, lasse mich durch Stress nicht aus der Ruhe bringen.', 'BFI-10'),
	(405, 'Ich habe nur wenig künstlerisches Interesse.', 'BFI-10'),
	(406, 'Ich gehe aus mir heraus, bin gesellig.', 'BFI-10'),
	(407, 'Ich neige dazu, andere zu kritisieren.', 'BFI-10'),
	(408, 'Ich erledige Aufgaben gründlich.', 'BFI-10'),
	(409, 'Ich werde leicht nervös und unsicher.', 'BFI-10'),
	(410, 'Ich habe eine aktive Vorstellungskraft, bin fantasievoll.', 'BFI-10'),
	
	(501, 'Im Streit bleibe ich stets sachlich und objektiv.','KSE-G'),
	(502, 'Auch wenn ich selbst gestresst bin, behandle ich andere immer freundlich und zuvorkommend.','KSE-G'),
	(503, 'Wenn ich mich mit jemandem unterhalte, höre ich ihm immer aufmerksam zu.','KSE-G'),
	(504, 'Es ist schon mal vorgekommen, dass ich jemanden ausgenutzt habe.','KSE-G'),
	(505, 'Ich habe schon mal Müll einfach in die Landschaft oder auf die Straße geworfen.','KSE-G'),
	(506, 'Manchmal helfe ich jemandem nur, wenn ich eine Gegenleistung erwarten kann.','KSE-G'),
	
	(601, 'Ich muss mich sehr dazu antreiben, etwas zu tun.', 'Nicht-klinische Depressivität'),
	(602, 'Vieles erscheint mir so sinnlos.', 'Nicht-klinische Depressivität'),
	(603, 'Mich bedrücken Schuldgefühle.', 'Nicht-klinische Depressivität'),
	(604, 'Ich fühle mich einsam, selbst wenn ich mit anderen Menschen zusammen bin.', 'Nicht-klinische Depressivität'),
	(605, 'Ich habe traurige Stimmungen.', 'Nicht-klinische Depressivität'),
	(606, 'Ich finde es schwer, Entscheidungen zu treffen.', 'Nicht-klinische Depressivität'),
	(607, 'Am Anfang des Tages fühle ich mich am schlechtesten.', 'Nicht-klinische Depressivität'),
	(608, 'Ich sehe ohne Hoffnung in die Zukunft.', 'Nicht-klinische Depressivität'),
...
INSERT INTO questionaire(
	...
	(2,'Es folgen fünf Aussagen, denen Sie zustimmen bzw. die Sie ablehnen können. Bitte benutzen Sie die folgende Skala von 1-7, um Ihre Zustimmung bzw. Ablehnung zu jeder Aussage zum Ausdruck zu bringen.','SWLS'),
